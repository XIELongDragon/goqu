...
func (dcs *deleteClausesSuite) TestOrder() {
	...
	dcs.Equal(exp.NewColumnListExpression(nil, "db", oe), c2.Order())
}
...
func (dcs *deleteClausesSuite) TestClearOrder() {
	...
	dcs.Equal(exp.NewColumnListExpression(nil, "db", oe), c.Order())
...
func (dcs *deleteClausesSuite) TestSetOrder() {
	...
	dcs.Equal(exp.NewColumnListExpression(nil, "db", oe2), c2.Order())
}
...
func (dcs *deleteClausesSuite) TestOrderAppend() {
	...
	dcs.Equal(exp.NewColumnListExpression(nil, "db", oe, oe2), c2.Order())
}
...
func (dcs *deleteClausesSuite) TestOrderPrepend() {
	...
	dcs.Equal(exp.NewColumnListExpression(nil, "db", oe2, oe), c2.Order())
}
...
func (dcs *deleteClausesSuite) TestReturning() {
	cl := exp.NewColumnListExpression(nil, "db", exp.NewIdentifierExpression("", "", "col"))
...
func (dcs *deleteClausesSuite) TestSetReturning() {
	cl := exp.NewColumnListExpression(nil, "db", exp.NewIdentifierExpression("", "", "col"))
	cl2 := exp.NewColumnListExpression(nil, "db", exp.NewIdentifierExpression("", "", "col2"))
